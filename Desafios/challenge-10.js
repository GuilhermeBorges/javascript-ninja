(function () {
  ...
  */
  ...
  console.log(showOperationMessage('+', 1, 3))
  /*
  ...
  */
  function minhaFunc (op, n1, n2) {
    let funcao = calculator(op)
    if (funcao) {
      console.log(showOperationMessage(op, n1, n2), funcao(n1, n2))
    } else { console.log(showErrorMessage(op)) }
  }

  ['+', '-', '*', '/', '%'].forEach(op => minhaFunc(op, 1, 2))
