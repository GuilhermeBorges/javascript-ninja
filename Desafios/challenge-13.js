(function () {
  ...
  */
  ...
  brasil.unshift('Acre', 'Amazonas', 'Rondônia') // retorna o length do array
  console.log(brasil)
  /*
  ...
  */
  let nordeste = ['Bahia Bahia', 'Pernambuco', 'Ceará', 'Maranhão', 'Rio Grande do Norte', 'Paraíba', 'Piauí', 'Alagoas', 'Sergipe']
  ...
  */
  // brasil.splice(0, 0, ...newSudeste)
  // brasil.concat(newSudeste)
  ...
  */
  let newBrasil = []
  brasil.forEach((element, index) => newBrasil.push({id: index, estado: element}))
...
// )
  ...
  */
  let filter = map.filter(e => e.id % 2 === 0)
  /*
